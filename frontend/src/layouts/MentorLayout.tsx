// =============================================================================
// File: frontend/src/layouts/MentorLayout.tsx
// Purpose: Core sidebar/header shell layout for authenticated mentors
// =============================================================================
...
export const MentorLayout: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Force listener for manual notification marking to refresh unread count immediately
  ...
  const menuItems = [
    { name: 'Overview', path: '/mentor', icon: <LayoutDashboard className="h-4.5 w-4.5" /> },
    { name: 'My Interns', path: '/mentor/interns', icon: <Users className="h-4.5 w-4.5" /> },
    { name: 'Intern Attendance', path: '/mentor/attendance', icon: <Calendar className="h-4.5 w-4.5" /> },
    { name: 'Daily Reports', path: '/mentor/reports', icon: <CheckSquare className="h-4.5 w-4.5" /> },
    { name: 'Project Milestones', path: '/mentor/projects', icon: <FolderGit2 className="h-4.5 w-4.5" /> },
    { name: 'Notifications', path: '/mentor/notifications', icon: (
    ...
    { name: 'Profile', path: '/mentor/profile', icon: <UserIcon className="h-4.5 w-4.5" /> },
  ];
    ...
    <div className="min-h-screen flex bg-slate-950 text-slate-100 font-sans selection:bg-indigo-500 selection:text-white">
        ...
        <div className="p-4 border-t border-slate-800/50 bg-slate-900/40">
          <div className="flex items-center gap-3 p-2 rounded-xl">
            ...
            <div className="flex-grow overflow-hidden">
              ...
              <p className="text-[10px] text-indigo-400 font-bold uppercase tracking-wider">Evaluation Hub</p>
            </div>
          </div>
        </div>
      </aside>
      ...
      <div className="flex-grow flex flex-col min-w-0">
        ...
        <header className="h-16 bg-slate-900/60 border-b border-slate-900 flex items-center justify-between px-4 sm:px-6 lg:px-8 relative z-40">
          ...
          {/* Right: Notification Quickbell & Mentor User Dropdown */}
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              ...
              >
                <div className="h-7 w-7 rounded-lg bg-indigo-650 flex items-center justify-center text-white font-bold text-xs">
                  {user?.firstName.charAt(0) || 'M'}
                </div>
