// =============================================================================
// File: frontend/src/pages/intern/InternNotificationsPage.tsx
// Purpose: Notifications inbox page for intern alerts
// =============================================================================
...
export const InternNotificationsPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">
            Review alerts generated from internship status adjustments, milestone updates, and report reviews.
          </p>
        </div>
        ...
        {unreadCount > 0 && (
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2.5 rounded-xl bg-slate-900 border border-slate-850 hover:border-slate-700 text-slate-300 hover:text-white font-semibold text-xs transition-colors focus:outline-none"
          >
      ...
      <div className="p-4.5 rounded-xl bg-slate-900 border border-slate-850 flex items-start gap-3">
        <Info className="h-4.5 w-4.5 text-emerald-450 flex-shrink-0 mt-0.5" />
        <p className="text-xs text-slate-400 leading-relaxed">
          System notifications are logged in the database and linked to specific action entities. Actionable items are automatically cleared or updated when their status changes.
        </p>
      </div>
    </div>
  );
...
export default InternNotificationsPage;
