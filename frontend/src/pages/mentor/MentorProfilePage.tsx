// =============================================================================
// File: frontend/src/pages/mentor/MentorProfilePage.tsx
// Purpose: Mentor profile details view with logout confirmation controls
// =============================================================================
...
const InfoRow: React.FC<InfoRowProps> = ({ icon, label, value }) => (
  <div className="flex items-start gap-4 p-4 rounded-xl bg-slate-900 border border-slate-850 hover:border-slate-700 transition-colors">
    <div className="mt-0.5 p-2 rounded-lg bg-indigo-650/10 border border-indigo-500/20 text-indigo-400 flex-shrink-0">
      {icon}
    </div>
    ...
    <div className="space-y-8 animate-in fade-in duration-300 max-w-2xl">
      ...
      <div>
        ...
        <p className="text-sm text-slate-400 mt-1">
          Mentor evaluation hub profile information and session controls.
        </p>
      </div>
      ...
      <div className="p-6 sm:p-8 rounded-2xl bg-slate-900/60 border border-slate-800/80 shadow-xl relative overflow-hidden">
        ...
        <div className="flex items-center gap-5 mb-8">
          ...
          <div>
            ...
            <span className="inline-flex mt-1.5 items-center gap-1.5 text-[10px] uppercase font-bold tracking-widest text-indigo-400 bg-indigo-950/40 px-2.5 py-0.5 rounded border border-indigo-900/30">
        ...
        <div className="space-y-3">
          ...
          <InfoRow
            ...
            value={user?.mentorProfile?.department || 'Engineering'}
          />
          <InfoRow
            icon={<Layers className="h-4 w-4" />}
            label="Key Expertise"
            value={user?.mentorProfile?.expertise || 'General Software Engineering'}
          />
          {user?.mentorProfile?.bio && (
            <InfoRow
              icon={<FileText className="h-4 w-4" />}
              label="Professional Bio"
              value={user.mentorProfile.bio}
            />
          )}
          <InfoRow
      ...
      <div className="p-6 rounded-2xl bg-slate-900/60 border border-slate-800/80 shadow-xl">
        ...
        <p className="text-xs text-slate-500 mb-6">
          You are currently signed in as a Mentor. Signing out will end your session and redirect you to the login page.
        </p>
        ...
        {!logoutConfirm ? (
          ...
          <div className="p-4 rounded-xl bg-rose-950/30 border border-rose-900/40 space-y-4">
            ...
            <div className="flex items-center gap-3">
              <button
                id="mentor-profile-signout-confirm-btn"
              ...
              <button
                id="mentor-profile-signout-cancel-btn"
